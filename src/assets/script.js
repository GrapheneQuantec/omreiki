...
function selectAffirmation(toBeSelected) {
  ...
  console.log('#' + toBeSelected.attr('id'));
  jQuery('#affirmation_' + toBeSelected.attr('id')).show();
}
...
jQuery( document ).ready(function() {
  ...
  jQuery('.selectAffirmation').click(function(e){
    console.log("clicked", e);
    if (e.ctrlKey) {
      jQuery(this).toggleClass('quantec');
    }
    else {
      selectAffirmation(jQuery(e.target));
    }
  });
